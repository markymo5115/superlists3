...
class NewVisitorTest(LiveServerTestCase):
    ...
    def test_multiple_users_can_start_lists_at_difference_urls(self):
        ...
        #Francis starts a new list by entering a new ite. He
        ...
        # Whe visits that URL - her to-do list is still there.
